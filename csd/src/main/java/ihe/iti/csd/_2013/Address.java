...
public class Address {
    ...
    protected List<Address.AddressLine> addressLine;
     ...
     * {@link Address.AddressLine }
     * 
     * 
     */
    public List<Address.AddressLine> getAddressLine() {
        if (addressLine == null) {
            addressLine = new ArrayList<Address.AddressLine>();
        }
